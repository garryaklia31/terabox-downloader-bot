API_ID =  "28386099" # api id
API_HASH = "a0057fbf1ca49ce5e9d26fd4afd6e78b"  # api hash

BOT_TOKEN = "6370496158:AAEvIGkCufbe0BO7eqIGpMpB7fNJsOXceY4"  # bot token


## REDIS
HOST = "redis-19765.c267.us-east-1-4.ec2.cloud.redislabs.com:19765"  # redis host uri
PORT = 6379  # redis port
PASSWORD = "Mehakpreet@572"  # redis password

PRIVATE_CHAT_ID = -1002074421298  # CHAT WHERE YOU WANT TO STORE VIDEOS
